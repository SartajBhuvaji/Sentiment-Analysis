...
class Transformer:
    def __init__(self):
        """
        Initializes the Transformer class by loading the sentiment analysis model and tokenizer, 
        and initializing the common_util object to preprocess the data.
        """
    ...
    def run_model(self):
        """
        Runs the sentiment analysis model on the preprocessed comments data and returns the resulting dataframe.
        """
        scores = []
